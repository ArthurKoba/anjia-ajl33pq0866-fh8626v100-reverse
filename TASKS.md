...
29. AJL-specific policy now has a clean staging home in `openipc-builder/rework/fh8626v100-anjia-clean-profile@3c125cbe...`, rebuilt from current Builder master. Its kernel fragment selects `CONFIG_FH8626V100_SD0_1BIT=y`; the old `CONFIG_FH8626V100_AJL33PQ0866_MMC` symbol is absent. Next gate is integration with the Firmware source Builder consumes, then owner build/hardware validation.
