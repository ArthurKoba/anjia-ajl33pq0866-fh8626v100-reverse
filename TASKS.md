...
45. **Majestic offline media staging advanced:** Firmware `work/fh8626v100-majestic@e00cae3d...` now carries the ABI probe, sensor 0x7c->0x68 facade, source VMM and DSP/SYS/VPSS/VENC facades, fixed native 720p25 H.264/VBR bring-up, balanced stream translation, source RTX audio MPI facade, strict/permissive/native-video runners, and loader-complete optional DSP/JPEG stubs. HTTP/WebUI remains owned directly by Majestic; no proxy or frontend patch is accepted.
