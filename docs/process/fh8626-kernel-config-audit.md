...
- Firmware post-config-audit checkpoint: `work/fh8626v100@c437d6eb62ade81595c20cbb765b8ad10300e3e7`.
- Current streamer-neutral Firmware core: `work/fh8626v100@eabd1ccd4684af6997771269c4655f7e4435bcec`.
...
The next owner build must use exact Firmware core `work/fh8626v100@eabd1ccd4684af6997771269c4655f7e4435bcec` and Linux `357c2d13...`, then record:
