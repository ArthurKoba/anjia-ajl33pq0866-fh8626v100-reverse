...
Это ранняя форма будущего принципа «не заставлять пользователя предварительно анализировать/чистить evidence». В дальнейшем она развивается в archive/workspace, full searchable artifacts и MCP.
