...
This directory now stores only the **project-specific historical case study** for the ANJIA AJL33PQ0866 / FH8626V100 reverse and porting effort.
...
Git history preserves the former audit files for provenance, but they are no longer active authority.
